...
public final class ModEnchantments {
	public static final DeferredRegister<Enchantment> VANILLA_ENCHANTS = DeferredRegister
			.create(ForgeRegistries.ENCHANTMENTS, "minecraft");
	public static final DeferredRegister<Enchantment> ENCHANTS = DeferredRegister.create(ForgeRegistries.ENCHANTMENTS,
			ServerMod.MODID);

	public static RegistryObject<Enchantment> register(final String name,
			final Supplier<? extends Enchantment> supplier) {
		return ENCHANTS.register(name, supplier);
	}

	public static RegistryObject<Enchantment> registerVanilla(final String name,
			final Supplier<? extends Enchantment> supplier) {
	...
	public static final RegistryObject<Enchantment> MOD_LOOTING = registerVanilla("looting",
			() -> new ModLootBonusEnchant(Rarity.RARE, ModEnchantHelper.ALL_WEAPONS, ModEnchantHelper.SLOT_HAND));
	public static final RegistryObject<Enchantment> MOD_FORTUNE = registerVanilla("fortune",
			() -> new ModLootBonusEnchant(Rarity.RARE, EnchantmentType.DIGGER, ModEnchantHelper.SLOT_HAND));
	
	public static final RegistryObject<Enchantment> MOD_PROTECTION_ALL = registerVanilla("protection",
			() -> new ModProtectionEnchant(Rarity.COMMON, ModProtectionEnchant.Type.ALL, ModEnchantHelper.SLOT_ARMOR));
	public static final RegistryObject<Enchantment> MOD_PROTECTION_FIRE = registerVanilla("fire_protection",
			() -> new ModProtectionEnchant(Rarity.UNCOMMON, ModProtectionEnchant.Type.FIRE, ModEnchantHelper.SLOT_ARMOR));
	public static final RegistryObject<Enchantment> MOD_PROTECTION_PROJ = registerVanilla("projectile_protection",
			() -> new ModProtectionEnchant(Rarity.UNCOMMON, ModProtectionEnchant.Type.PROJECTILE, ModEnchantHelper.SLOT_ARMOR));
	public static final RegistryObject<Enchantment> MOD_PROTECTION_BLAST = registerVanilla("blast_protection",
			() -> new ModProtectionEnchant(Rarity.RARE, ModProtectionEnchant.Type.EXPLOSION, ModEnchantHelper.SLOT_ARMOR));
	public static final RegistryObject<Enchantment> MOD_PROTECTION_FALL = registerVanilla("feather_falling",
			() -> new ModProtectionEnchant(Rarity.UNCOMMON, ModProtectionEnchant.Type.FALL, EquipmentSlotType.FEET));
	
	public static final RegistryObject<Enchantment> MOD_UNBREAKING = registerVanilla("unbreaking",
			() -> new ModUnbreakingEnchant(Rarity.UNCOMMON, ModEnchantHelper.SLOT_ALL));
	public static final RegistryObject<Enchantment> MOD_EFFICIENCY = registerVanilla("efficiency",
